...
If Flag_UpdateEmu68 = "TRUE" then DO
   vCmd = DeviceListPath 'device_name='Drivername1','Drivername2' raw_dostype='TargetDostype' NOFORMATTABLE >'ListofEmu68DisksFile 
   vCmd
   FAT32Device = ''
   if READFILE(ListofEmu68DisksFile,ListofDisks) then DO
      ...
      DO i=1 to ListofDisks.0
         ...
         if vRawDosType='0x46415401' & (vDeviceName = Drivername1 | vDeviceName = Drivername2) then found_count = found_count + 1
